...
-- Skill Bridge
CREATE INDEX idx_bridge_skill
ON bridge_job_skill(skill_id);

CREATE INDEX idx_bridge_fact_skill
ON bridge_job_skill(fact_job_id);

-- Benefit Bridge
CREATE INDEX idx_bridge_benefit
ON bridge_job_benefit(benefit_id);

CREATE INDEX idx_bridge_fact_benefit
